...
class User extends Authenticatable
{
    ...
    public function Movies(){
        return $this->belongstoMany(Movie::class,'rents')->withPivot(['dateRent','dateReturn']);
    }

    public function Rent_movies(){
        return $this->belongsToMany(Movie::class,'rents')->withPivot(['dateRent','dateReturn'])->wherePivot('dateReturn',null);
    }
    /**
